...
% Chống dòng mồ côi (widow/orphan) ở đầu và cuối trang
\widowpenalty=10000
\clubpenalty=10000
\brokenpenalty=10000
...
\fancyhead[R]{\small Học phần: \CourseCode}
\fancyfoot[C]{\thepage}
...
\newcommand{\CodePath}[1]{{\urlstyle{same}\nolinkurl{#1}}}
...
\input{chapters/chapter1_supplement.tex}
